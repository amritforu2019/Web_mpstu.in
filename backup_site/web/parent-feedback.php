...
if(isset($_POST['consub']))
{
	...
	{ 
    	...
    	header("location:parent-feedback");
		exit;		
	}
	else
	{  
		...
		mysqli_query($DB_LINK, "insert into tbl_contact_qry set s_name='".ucwords($_POST['name'])."', email='$_POST[email]', contact='$_POST[phone]', subject='$_POST[subject]',   msg='$_POST[msg]', status=0, ipaddress='".$_SERVER['REMOTE_ADDR']."',typ='Parent Feedback' ");
	 ...
	 <tr>
       ...
       <td colspan="3" align="left"><a href=' . $SITE_URL . '>View Website</a></td> 
		...
		else
		{
			 ...
			 $_SESSION['msg']=array('error', 'Your Query not Sent. Something went wrong'); header("location:parent-feedback");
			exit;
		}
	}
}
...
<head>
		...
		<title>Parent's Feedback | <?php echo $SITE_NAME; ?></title>
				...
				<div class="row">
					<div class="col-12">
						...
						<ul class="bread-list">
							...
							<li class="active"><a href="#">Parent's Feedback</a></li>
						</ul>
					</div>
				</div>
			</div>
				...
				<div class="row">
					<div class="col-lg-8 col-sm-8 col-12">
						<div class="single-image  ">
							 <img src="<?php echo $SITE_URL;?>/assets/links/images/feedback.jpg" alt="Feedback">
