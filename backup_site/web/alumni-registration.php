...
if(isset($_POST['consub']))
{
	...
	{  
		...
		mysqli_query($DB_LINK, "insert into tbl_contact_qry set s_name='".ucwords($_POST['name'])."', email='$_POST[email]', contact='$_POST[phone]', subject='$_POST[subject]',   msg='$_POST[msg]', status=0, ipaddress='".$_SERVER['REMOTE_ADDR']."',typ='Alumni Registration'");
	...
	<tr>
     ...
     <tr>
       <td>Session and Passing Year</td> 
	   <td valign="top" >:</td>
       <td>' . $_POST['subject'] . '</td>
      </tr>
	<tr>
	 <tr>
       ...
       <td colspan="3" align="left"><a href=' . $SITE_URL . '>View Website</a></td> 
            ...
            mail_sender($subject, $mail_body, $_POST['email'], $_POST['name']);
			 ...
			 $_SESSION['msg']=array('success', 'Your Registration Saved  Successfully!! We will contact you soon!!');
		...
		else
		{
			 ...
			 $_SESSION['msg']=array('error', 'Sorry !!! Something went wrong'); header("location:alumni");
			exit;
		}
	}
}
...
<head>
		...
		<title>Alumni Registration | <?php echo $SITE_NAME; ?></title>
				...
				<div class="row">
					<div class="col-12">
						...
						<ul class="bread-list">
							...
							<li class="active"><a href="#">Alumni Registration</a></li>
						</ul>
					</div>
				</div>
			</div>
				...
				<div class="row">
					<div class="col-lg-8 col-sm-8 col-12">
						<div class="single-image  ">
							 <img src="<?php echo $SITE_URL;?>/assets/links/images/alumni.png" alt="Inquiry">
					...
					<div class="form-group">
					<input type="text" name="subject" class="form-control" placeholder="Session and Passing Year" required>
					</div>
					<div class="form-group">
