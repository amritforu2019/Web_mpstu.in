...
<head>
	...
	<?php require("include/slider2.php");?>
			...
			?> 
							<div class="single-course">
								<div class="course-head overlay">
									<img src="<?php echo $SITE_URL;?>/assets/upload/category/<?php echo $rowtop['image'];?>" alt="<?php echo $rowtop['title'];?>">
					...
					<div class="col-lg-4 offset-lg-8 col-12 col-sm-12">
						<div class="cta-inner overlay">
							<div class="text-content">
								...
								<div class="button">
									<a class="btn primary wow fadeInUp" href="<?php echo show_content('320','url',$DB_LINK);?>" >Read More</a>
								</div>
							</div>
						</div>
					</div>
			...
			?> 
							<div class="single-event">
								<div class="head overlay">
									<img src="<?php echo $SITE_URL;?>/assets/upload/category/<?php echo $rowtop['image'];?>" alt="#">
