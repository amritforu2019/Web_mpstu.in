...
if(isset($_GET['del']))
{
    ...
    header("location:contact-career");
	exit;
}
?>
<!DOCTYPE html>
...
<meta charset="utf-8" />
<title>Career Registration Data :: <?php echo $SITE_NAME;?></title>
    ...
    <div class="main-content-inner">
      <div class="breadcrumbs ace-save-state" id="breadcrumbs">
        <ul class="breadcrumb">
          <li> <i class="ace-icon fa fa-home home-icon"></i> <a href="index">Home</a> </li>
           <li class="active">Career Registration Data</li>
        </ul>
        <!-- /.breadcrumb -->
      </div>
      <div class="page-content">
        <!-- /.page-header -->
          ...
          <h1>Career Registration Data</h1>
        </div>
        <div class="row">
          ...
          <div class="col-xs-12">
            <div class="clearfix">
              <div class="pull-right tableTools-container"> </div>
                ...
                <?php
				$i=1; 
				$qry=mysqli_query($DB_LINK,"select * from tbl_contact_qry where typ='Career Query'  order by id desc");
				foreach($qry as $row)
				{  
                    ...
                    <tr class="table-activity">
                      ...
                      <div class="tools action-buttons"><?php /*?> <a href="job_edit?edit=<?php echo $row['id'];?>" title="Edit" class="blue"><i class="ace-icon fa fa-pencil bigger-125"></i></a>
                       ...
                       <?php if($row['status']==1){ ?>
                        ...
                        <?php }?><?php */?>
                       <a class="red" onClick="return del(<?php echo $row['id'];?>, 'contact-career')"> <i class="ace-icon fa fa-times bigger-125" title="Delete"></i> </a> 
                       </div>
                      </td>
