...
if(isset($_POST['submit']))
{
	...
	if(mysqli_query($DB_LINK,"update tbl_setting set $i1 site_url='$site_url', site_name='$site_name', site_admin_title='$site_admin_title', email='$email', mobile='".$_POST['mobile']."',mobile2='".$_POST['mobile2']."',
	 address='".$address."', f='".$f."', l='".$l."', t='".$t."', y='".$y."', g='".$g."'"))
 	{	
          ...
          <div class="col-xs-12">
            ...
            <div class="widget-box transparent" id="recent-box">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-9">
                  <input type="text" placeholder="Enter 2nd Mobile" class="form-control" name="mobile2" value="<?php if(isset($row['mobile2'])) echo ($row['mobile2']); ?>"     />
                </div>
              </div>
              <div class="form-group">
