                ...
                <div class="row">
                    <div class="col-lg-12">
                     <div class="row1">
						...
						$q=mysql_query("select * from category6 WHERE  id='".$_REQUEST['page']."' "); $details_fetch=mysql_fetch_array($q);
						?>
                        
                        <div class="leftbx-13">
                            	<h1><?=$details_fetch['weight']?></h1>
                                <p> <?=stripslashes($details_fetch['descr'])?></p>
                                <?php if($details_fetch['pile_height']!='') {  ?><a href="../product/category/<?php echo $details_fetch['pile_height'] ; ?>">Download Link</a> <? } ?>  
                            </div>
