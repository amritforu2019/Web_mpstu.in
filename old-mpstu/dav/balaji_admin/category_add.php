  ...
  <tr>
    ...
    <td width="750" align="center"><div id="mid">
        <table width="98%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#274663">
          ...
          <tr>
            <td valign="top" bgcolor="#FFFFFF"><form action="category_add.php" method="post" enctype="multipart/form-data" name="form1">
                <p>
                  <?
if(isset($_GET['edit']))
{
...
$q=mysql_query("update category set parent_id='".$_POST['country']."', name='".$_POST['name']."' , weight='".$_POST['weight']."' ,  imname='$finame',  descr='".addslashes($_POST['descr'])."' $file where id='$a'")or die(mysql_error());
...
$q=mysql_query("update category set parent_id='".$_POST['country']."', name='".$_POST['name']."' , weight='".$_POST['weight']."',   show_on='".$_POST['show_on']."' , descr='".addslashes($_POST['descr'])."' $file where id='$a'")or die(mysql_error());
$_SESSION['sess_msg']="Menu Updated Successfully";
?>
<script>
window.location.href="category_list.php?country=<?=$_POST['country']?>";
...
?>
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="5">
                  ...
                  <tr>
<td height="22" class="bodytext">Upload Docs</td>
...
<tr>
      ...
      <td height="22" class="bodytext"><div align="right">Upload Image (If Needed ): </div></td>
	...
	filebrowserFlashUploadUrl : 'ckfinder/core/connector/php/connector.php?command=QuickUpload&type=Flash'
                  ...
                  <tr>
					...
					?>
                    <input name="go" type="submit" class="button" id="go" value="Add Menu" onClick="return chk();">
                    <? } 
					else { 
					?> <input name="go2" type="submit" class="button" id="go2" value="Update Menu" onClick="return chk();"> <?
					}?>
                    </td>
                  </tr>
                </table>
