  ...
  <tr>
	...
	<div id="mid">  
		<table width="98%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#274663">
            ...
            <tr>
              <td bgcolor="#FFFFFF" valign="top"><form action="product_add1.php" method="post" enctype="multipart/form-data" name="form1">
			 ...
			 { 
...

			  {
			 		 ...
			 		 require_once("updateproduct1.php");
			  ...
			  ?>
                  ...
                  <table width="100%" border="0" cellspacing="4" cellpadding="2">
					...
					?>
					  ...
					  <tr>
                        ...
                        <td><input name="weight" type="text" class="bodytext" id="cname3" size="50" value="<? if(isset($_GET['edit'] )) echo $row['weight'];  else echo stripslashes($_POST['weight']);?>"></td>
 				...
 				<tr>
                        ...
                        <td><input name="price_offer" type="text" class="bodytext" size="50" value="<? if(isset($_GET['edit'] )) echo $row['price_offer'];  else echo stripslashes($_POST['price_offer']);?>"></td>
