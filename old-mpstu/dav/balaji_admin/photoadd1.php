  ...
  <tr>
	...
	<div id="mid">   
          <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#274663">
			   <tr>
                   <td height="30" colspan="2" bgcolor="#000" class="heading"><strong>Edit  Photo Tital :</strong> </td>
            </tr>
			   <tr>
			     <td colspan="2" bgcolor="#FFFFFF">
				    <form name="form1" method="post" action="photoadd1.php" enctype="multipart/form-data"> 
				  ...
				  <?  
...

					  {
						  ...
						  if($_POST['edit']!='') { 
								...
								mysql_query("update gallery set name='".addslashes($_POST['name'])."' where id='".$_POST['edit']."'")or die(mysql_error());

								$sess_msg="Photo Updated Successfully";
                ...
                <tr>
                  ...
                  <td height="22" align="right" nowrap class="hometext"><strong>Tital :</strong></td>
                  ...
                  <td align="left"><input name="go" type="submit" class="button" id="go" value="<? if(isset($_SESSION['naukri'])) echo "Update"; else echo "Update"?> Tital" onClick="return chk();"></td>
