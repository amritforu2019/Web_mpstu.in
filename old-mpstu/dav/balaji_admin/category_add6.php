  ...
  <tr>
    ...
    <td width="750" align="center"><div id="mid">
        <table width="98%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#274663">
          <tr>
            <td height="29" bgcolor="#0c5994" class="heading"><strong>Manage Why People Choose Us</strong></td>
          </tr>
          <tr>
            <td valign="top" bgcolor="#FFFFFF"><form action="category_add6.php" method="post" enctype="multipart/form-data" name="form1">
                <p>
...
$ty=$_GET['edit'];
$qry=mysql_query("select * from category6 where id='$ty' ")or die(mysql_error());
...
mysql_query("insert into category6 set parent_id='".$_POST['country']."', name='".$_POST['name']."', weight='".$_POST['weight']."', pile_height='".$_POST['pile_height']."' , imname='$finame', show_on='".$_POST['show_on']."',  status=1 , descr='".$_POST['descr']."'")or die(mysql_error());
header("Location:category_list6.php?country=".$_POST['country']);
exit;
}
...
if($finame!="")
{
$rw=mysql_query("select * from category6 where id='$a'");
$rw1=mysql_fetch_array($rw)or die(mysql_error());
$x=$rw1['imname'];
unlink("../product/category/".$x);  

$q=mysql_query("update category6 set parent_id='".$_POST['country']."', name='".$_POST['name']."' , weight='".$_POST['weight']."', pile_height='".$_POST['pile_height']."' ,  imname='$finame', show_on='".$_POST['show_on']."' , descr='".$_POST['descr']."' where id='$a'")or die(mysql_error());


$_SESSION['sess_msg']="Menu Updated Successfully";
?>
<script>
window.location.href="category_list6.php?country=<?=$_POST['country']?>";
</script>
<?
exit;
}
...
$q=mysql_query("update category6 set parent_id='".$_POST['country']."', name='".$_POST['name']."' , weight='".$_POST['weight']."', pile_height='".$_POST['pile_height']."'  ,  show_on='".$_POST['show_on']."' , descr='".$_POST['descr']."' where id='$a'")or die(mysql_error());
$_SESSION['sess_msg']="Menu Updated Successfully";
?>
<script>
window.location.href="category_list6.php?country=<?=$_POST['country']?>";
...
?>
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="5">
                  <tr>
                    <td width="28%" class="bodytext"><div align="right"></div></td>
                    <td width="72%"><select name="country" class="bodytext" style="display:none" >
					...
					?>
                        ...
                        <?  $country_qry1=mysql_query("select * from category6 where parent_id='".$country_fetch['id']."' order by name asc")or die(mysql_error());
					...
					?>
                        ...
                        <?  $country_qry2=mysql_query("select * from category6 where parent_id='".$country_fetch1['id']."' order by name asc")or die(mysql_error());
                  ...
                  <tr>
                        ...
                        <td height="22" class="bodytext"><div align="right"> Image: </div></td>
