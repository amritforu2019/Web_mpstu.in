...

{
	...
	location.href='product_list1.php?category='+val;
  ...
  <tr>
	...
	<div id="mid">  
		<table width="98%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#274663">
            ...
            <tr>
              <td bgcolor="#FFFFFF" valign="top"><form name="form1" method="post" action="product_list1.php">
...

				{
						...
						$arr=$_GET['del'];
							...
							$cn=mysql_query("select imname from product1 where id='$arr'")or die(mysql_error());
							...
							mysql_query("delete from product1 where id='$arr'")or die(mysql_error());

							$sess_msg="Product Deleted Successfully";

							$_SESSION['sess_msg']=$sess_msg;

							header("Location: product_list1.php?category=".$_REQUEST['category']."&start=".$_REQUEST['start']);
...

					{
						...
						mysql_query("update product1 set status=0 where id=".$_GET['ban']);
...

					{
						...
						mysql_query("update product1 set status=1 where id=".$_GET['unban']);
...

					{
						...
						mysql_query("update product1 set featured=1 where id=".$_GET['fea']);
...

					{
						...
						mysql_query("update product1 set featured=0 where id=".$_GET['unfea']);
				  ...
				  $q=mysql_query("select * from product1  $where order by  id desc limit $start, $pagesize");

				  $q1=mysql_query("select * from product1  $where order by  id desc ");
                ...
                <table width="85%" border="0" align="center" cellpadding="0" cellspacing="0">
					...
					$country_qry=mysql_query("select * from category1 where parent_id=0 order by name asc")or die(mysql_error());
					...
					?>
							...
							<?  $country_qry1=mysql_query("select * from category1 where parent_id='".$country_fetch['id']."' order by name asc")or die(mysql_error());
					...
					?>
							...
							<?  $country_qry2=mysql_query("select * from category1 where parent_id='".$country_fetch1['id']."' order by name asc")or die(mysql_error());
					...
					?>
                        ...
                        <td width="20%" valign="top"><input name="gone" type="button" class="button" id="gone" value="Add New Product" onClick="javascript:window.location.href='product_add1.php?yahoo=fsf&category=<? echo $_REQUEST['category']?>'"></td>
				...
				?>
                      ...
                      <tr bgcolor="#F2F2F2" class="textli">
                        ...
                        <td align="center" valign="top" class="bodytext" style="line-height:25px;">
                            ...
                            <div align="center">
                              ...
                              <? if($featured==1){?>
                                ...
                                <a href="product_list1.php?unfea=<?  echo $id?>&category=<? echo $parent_id;?>&start=<? echo $_REQUEST['start'];?>" ><img src="../images/featured.gif" alt="Featured Product" width="15" height="15" vspace="3" border="0"></a>
                        ...
                        <td valign="top" class="bodytext" style="padding-left:20px; line-height:25px;">
							...
							<strong>Mobile No. - </strong><?  echo normal_filter($item_code)?><br> 

							<!--<strong>Size  - </strong><?  echo normal_filter($color)?><br> 
-->
							<strong>Email Id  - </strong><?  echo normal_filter($weight)?><br> 

							<strong>Address   - </strong><?  echo normal_filter($price_offer)?>
                      ...
                      <td class="bodytext">&nbsp;&nbsp;<a href="product_add1.php?edit=<?  echo $id?>&category=<? echo $parent_id;?>&start=<? echo $_REQUEST['start'];?>"><img src="images/but_edit_small.gif" alt="Edit Product" width="22" height="22" border="0"></a>

						<a href="product_list1.php?del=<?  echo $id?>&category=<? echo $parent_id;?>&start=<? echo $_REQUEST['start'];?>" onClick="return del();"><img src="images/but_delete_small.gif" alt="Delete Product" width="22" height="22" border="0"></a>

                          <? if($status==0){?>

                          <a href="product_list1.php?unban=<?  echo $id?>&category=<? echo $parent_id;?>&start=<? echo $_REQUEST['start'];?>" ><img src="images/but_unban_small.gif" alt="Unban Product" width="22" height="22" border="0"></a>

                          <? }

						  else { ?>

                          <a href="product_list1.php?ban=<?  echo $id?>&category=<? echo $parent_id;?>&start=<? echo $_REQUEST['start'];?>" ><img src="images/but_ban_small.gif" alt="Ban Product" width="22" height="22" border="0"></a>

                          <? } ?>

						  <? if($featured==0){?>

						  <a href="product_list1.php?fea=<?  echo $id?>&category=<? echo $parent_id;?>&start=<? echo $_REQUEST['start'];?>" ><img src="images/featured.gif" alt="Featured Product" width="15" height="15" vspace="3" border="0"></a>
				...
				{?>
                    ...
                    <div align="center"><span class="red"><strong>Currently 
                      ...
                      No Product  Available .., Please</strong></span> <span class="leftlinks"><a href="product_add1.php?yahoo=sfsfs&category=<? echo $_REQUEST['category'];?>" class="boldlisting">Add 
