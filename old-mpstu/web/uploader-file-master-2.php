...
function uploadmaster($folder_name,$uploder_name)
{
	...
	if((!empty($_FILES[$uploder_name])) && ($_FILES[$uploder_name]['error'] == 0))
	{
		...
		$bn_ext=$ext;
		///($ext == "jpg")||($ext == "jpeg")||($ext == "bmp")||($ext == "gif")||($ext == "JPEG")||($ext == "JPG")||($ext == "png")||||($ext == "pdf")
 		if (($ext == "docx") ||($ext == "doc") || ($ext == "jpg")||($ext == "jpeg")||($ext == "bmp")||($ext == "gif")||($ext == "JPEG")||($ext == "JPG")||($ext == "png")||($ext == "pdf")   &&($_FILES[$uploder_name]["size"] < 1000000)) 
		{
