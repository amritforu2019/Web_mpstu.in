...
<meta charset="utf-8" />
<title>Home Page Query List :: <?php echo $SITE_NAME;?></title>
      ...
      <div class="breadcrumbs ace-save-state" id="breadcrumbs">
        <ul class="breadcrumb">
          <li> <i class="ace-icon fa fa-home home-icon"></i> <a href="index">Home</a> </li>
           <li class="active">Home Page Query List</li>
        </ul>
        <!-- /.breadcrumb -->
      </div>
          ...
          <div class="col-xs-12">
            <div class="clearfix">
              <div class="pull-right tableTools-container"> </div>
                ...
                <?php
				$i=1; 
				$qry=mysqli_query($DB_LINK,"select * from tbl_contact_qry where typ='Home Page Enquiry'  order by id desc");
				foreach($qry as $row)
				{  
                    ...
                    <tr class="table-activity">
                      ...
                      <div class="tools action-buttons"><?php /*?> <a href="job_edit?edit=<?php echo $row['id'];?>" title="Edit" class="blue"><i class="ace-icon fa fa-pencil bigger-125"></i></a>
                       ...
                       <?php if($row['status']==1){ ?>
                        ...
                        <?php }?><?php */?>
                       <a class="red"onClick="return del(<?php echo $row['id'];?>, 'contact-home')"> <i class="ace-icon fa fa-times bigger-125" title="Delete"></i> </a> 
                       </div>
                      </td>
