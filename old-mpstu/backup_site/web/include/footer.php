<!-- Footer -->
 ...
 <li><a href="<?php  echo $L; ?>" target="_blank"><i class="fa fa-linkedin faa-wrench animated"></i></a></li>
...
-->
										...
										<div class="copyright">
											...
											<p>© Copyright <?=date('Y')?>-<?=date('y')+1?> <a href="#"><?php echo $SITE_NAME;?></a>. All Rights Reserved  
