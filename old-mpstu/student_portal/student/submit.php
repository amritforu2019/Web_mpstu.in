...
require_once("../con_base/config.inc.php"); 
 
 mysqli_query($DB_LINK,"update tbl_student set is_paid='0',pay_dt='".date("Y-m-d")."',pay_amt='".$_POST['amount']."',email='".$_POST['udf2']."',  
pay_mode='Online' ,trn_id_m='".$_POST['bookingid']."'    where enr_no='".$_POST['udf5']."' ");
...
class ProcessPayment {
	...
	function requestMerchant(){
		...
		$postFields .= "&txnid=".$_POST['bookingid'];//rand(0,999999);
