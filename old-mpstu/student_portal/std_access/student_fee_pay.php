    ...
    <td><?=$row_std['student_id'];?></td>
                      ...
                      <table width="30%"  border="1"  cellpadding="5" cellspacing="0" align="center" style="background-color:#ffffff ">
                          <tr>
                              ...
                              <td align="center"><a href="student_fee_pay_off.php?id=<?=$row_std['enr_no'];?>"  class="subm"     >Offline By Receipt</a></td>
                          </tr>
                  ...
                  <? } else { echo '<span style="color:red; text-align: center;">Fees Already Paid</span>' ; } } else { echo '<span style="color:red">!!! Student not found</span>' ; ?>
