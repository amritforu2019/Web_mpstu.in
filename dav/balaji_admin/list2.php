...
if($_REQUEST['del']!='')
			{
						  ...
						  if(mysql_query("delete from buy where id='".$_REQUEST['del']."'  ")or die(mysql_error()))
						  {
							  echo "<script>alert('Project Deleted');location.href='list2.php';</script>";
						  }
			...
			if(isset($_GET['ban']))

					{
						...
						mysql_query("update buy  set flag=0 where id=".$_GET['ban']);
...

					{
						...
						mysql_query("update buy set flag=1 where id=".$_GET['unban']);
  ...
  <tr>
	...
	<div id="mid">  
		<table width="100%" border="0" align="center" cellpadding="5" cellspacing="3" bgcolor="#FFFFFF" style="font-size:14px; line-height:25px;"> 
				    <tr>
				      <td height="25" colspan="6" align="center" bgcolor="#FFFFFF" style="color: font-size: 16px; font-size: 18px;">Buy Property Request</td>
	      </tr>
				    <tr> 
                   ...
                   <?php
				   $query_content=mysql_query("select * from buy  order by id asc");
				   $k=1; while($content_res=mysql_fetch_array($query_content)){ @extract($content_res);?>
				    <tr <?php if($k%2==0)echo 'bgcolor="#FFFFFF"';else echo'bgcolor="#F2F2F2"';?>> 
					  ...
					  <td align="center" >
                      <a href="list2.php?del=<?=$id;?>" onClick="return del();"><img src="images/but_delete_small.gif" alt="Edit Details" width="22" height="22" border="0"></a>
                      <!-- <? if($flag==0){?>

                      <a href="list2.php?unban=<?  echo $id?>" title="Activate Photo Gallery Category" ><img src="images/but_unban_small.gif" alt="Unban Page" width="22" height="22" border="0"></a>

                      <? }

						  else { ?>

                        <a href="list2.php?ban=<?  echo $id?>" title="Suspend Photo Gallery Category" ><img src="images/but_ban_small.gif" alt="Ban Page" width="22" height="22" border="0"></a>

                      <? } ?>--><td align="center" > <a href="project2.php?id=<?=$id;?>" style="font-size:12px;"> More</a></td>
                    </tr>
					<?php $k++; } ?>  
                  </table>
	</div>
