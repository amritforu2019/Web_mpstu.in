  ...
  <tr>
	...
	<div id="mid">  
		<table width="98%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#274663">
            <tr>
              <td height="29" bgcolor="#000" class="heading"><strong>Add News:</strong></td>
            </tr>
            <tr>
              <td bgcolor="#FFFFFF" valign="top"><form name="form1" method="post" action="">
				...
				{
						$arr=$_GET['del'];						
						mysql_query("delete from news  where id='$arr'")or die(mysql_error());
					...
					if(isset($_GET['ban']))
					{
						mysql_query("update news  set status=0 where id=".$_GET['ban']);
					...
					if(isset($_GET['unban']))
					{
						mysql_query("update news set status=1 where id=".$_GET['unban']);
				  ...
				  $q=mysql_query("select * from news  order by id asc"); 
                ...
                <table width="85%" height="69" border="0" align="center" cellpadding="0" cellspacing="0">
                 <tr>
                    <td align="right" valign="top"><input name="gone" type="submit" class="button" id="gone2" value="Add News &amp; Updates" onClick="location.href='news_add.php'"></td>
                  </tr>
                </table>
				...
				?>
                  <tr bgcolor="#F2F2F2" class="textli">
                    ...
                    <td width="23%" class="bodytext">&nbsp;&nbsp;<a href="news_add.php?edit=<?  echo  $id?>" title="Edit Page"><img src="images//but_edit_small.gif" alt="Edit Main Link" width="22" height="22" border="0"></a> <a href="news_list.php?del=<?  echo  $id?>" onClick="return del();" title="Delete Page"><img src="images//but_delete_small.gif" alt="Delete Category" width="22" height="22" border="0"></a>
                      <? if($status==0){?>
                      <a href="news_list.php?unban=<?  echo  $id?>" title="Activate Main Link" ><img src="images//but_unban_small.gif" alt="Unban Page" width="22" height="22" border="0"></a>
                      <? }
						  else { ?>
                      <a href="news_list.php?ban=<?  echo  $id?>" title="Suspend Main Link" ><img src="images//but_ban_small.gif" alt="Ban Page" width="22" height="22" border="0"></a>
                      <? } ?></td>
                  </tr>
                  <?
					$i++;
                ...
                <? }   else { ?>
                <div align="center"><span class="red"><strong>Currently No News &amp; Updates Available, Please</strong></span> <span class="leftlinks"><a href="news_add.php?yahoo=sfsfs" class="headlinks">Add First</a></span></div>
                <? }   ?>
              </form></td>
            </tr>
          </table>
