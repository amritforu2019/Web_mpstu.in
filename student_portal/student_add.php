...
='".$_POST["address"]."',dob ='".$_POST["dob"]."' , fee ='".$_POST["fee"]."' , email ='".$_POST["email"]."'  where `id`='".$_POST["edit"]."'  ";
...
$partyqry="INSERT INTO  `tbl_student` set `session` ='".$_POST["session"]."' , `category` ='".$_POST["category"]."' , `seat` ='".$_POST["seat"]."' , `course` ='".$_POST["course"]."' , 
