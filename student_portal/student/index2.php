...
<INPUT TYPE="hidden" NAME="ru" value="http://davpgcvns.ac.in/merchant/index.php">
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
 <tr>
        <td>* Name</td> 
        <td>:</td>
        <td><input name="udf1" type="text" value="amit singh" /></td>
    ...
    <tr>
        <td>* Email ID</td> 
        <td>:</td>
        <td><input name="udf2" type="text" value="amritfits@gmail.com" /></td>
    ...
    <tr>
        ...
        <td>* Mobile No</td> 
        <td>:</td>
        <td><input name="udf3" type="text" value="8726275933" /></td>
    ...
    <tr>
        ...
        <td><input name="udf4" type="text" value="varanasi"  /></td>
...
<td>:</td>
<td>
<input type="text" name="amount" value="55" />
    not less then 50
</td>
</tr>
