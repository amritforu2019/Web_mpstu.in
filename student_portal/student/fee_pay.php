...
<INPUT TYPE="hidden" NAME="product" value="DAV_PG">
...
<INPUT TYPE="hidden" NAME="ru" value="http://davpgcvns.ac.in/student_portel/student/response.php">
<input type="hidden" name="bookingid" value="<?=rand(1000000,9999999)?>"/>
								 <div class="form-group">
									 <label for="focusedinput" class="col-sm-2 control-label">Enrolment No.</label>
									 <div class="col-sm-8">
										 <input type="text" class="form-control1" id="focusedinput" name="udf5" value="<?=$get_data_std['enr_no']?>"    readonly  />
									 </div>
                                ...
                                <div class="form-group">
									...
									<div class="col-sm-8">
		 <input type="text" class="form-control1" id="focusedinput" name="udf2"   placeholder="Student Email Id " required  value="<?=$get_data_std['email']?>"  />
									</div>
                                ...
                                <div class="form-group">
									...
									<div class="col-sm-8">
										<?=$get_data_std['fee']?>
										<input type="hidden"   id="amount" name="amount" value="<?=$get_data_std['fee']?>"  />
									</div>
			 ...
			 ?>
						 ...
						 <?php } else {?> You are attempt a transaction kindly wait while we verify your transaction current status is pending <?php } ?>
						</form>
