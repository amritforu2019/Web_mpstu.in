...
<body>
 ...
 <form action="" style="border:none;" method="post" enctype="multipart/form-data" name="form1" id="form1">
  ...
  <tr> 
    ...
    <td width="91%" align="center" valign="top"  ><span class="ss"><span style="font-size:18px;">
...
$row1=mysqli_fetch_array($rs1); $qry1=mysqli_query($DB_LINK,"select * from college where coll_id='".$_SESSION['collid']."' ");
    ...
    <br>
     <? echo $row11['cont']; ?></span><br>
      <span style="font-size:16px;"> Registration Receipt</span></td>
  </tr>
...
?></strong></td>
  ...
  <tr>
    <td width="21%" align="left"> Enrol No.:</td>
    <td width="31%"><strong>
      <? echo $row1['enrol'];?>
      </strong><strong>
    ...
    <td width="22%"><strong><? echo date('d-M-Y',strtotime($row1['doj']))?>  </strong></td>
  </tr>
  <tr>
...
<div style="height:340px; vertical-align:top;">
 ...
 <tr>
      <td width="6%" align="center" bgcolor="#999999">Ledger</td>
      <td width="38%" align="center" bgcolor="#999999">Fee Name</td>
      <td width="34%" align="center" bgcolor="#999999">Total Fees</td>
      <td width="22%" align="center" bgcolor="#999999">Paid Amount</td>
      </tr>
			...
			<td width="6%" rowspan="3"  align="center" valign="top"  nowrap style="padding:5px 10px;  ">&nbsp;</td>

			<td width="38%" rowspan="3" align="center" valign="top" style="padding:5px 10px; ">

			Registration Fee  </td>

			<td width="34%" align="right" ><?  echo $row1['fofee']; ?></td>
			<td width="22%"  align="Right" >
            <?
            $feespaid=$row1['fopaid'];
			$disc=0;
        ...
        <td align="right" >
          Total :  </td>
        <td align="right" >
          <?  echo $totfee=$feespaid; ?>         </td>
      </tr> 

	      <tr>
	        <td align="right" >Balance</td>
	        <td align="right" ><?   echo $row1['fofee']-$totfee; ?></td>
	        </tr>
	      <tr>
      ...
      <td width="22%" align="center" bgcolor="#999999">Paid Amount</td>
	  	  ...
	  	  <tr>
	  	    ...
	  	    <td width="38%" rowspan="3" align="center" valign="top" style="padding:5px 10px; ">
	  	      ...
	  	      Registration Fee  </td>
	  	    <td align="right" ><?  echo $row1['fofee']; ?></td>
	  	    <td  align="Right" ><?
            $feespaid=$row1['fopaid'];
			$disc=0;
			$rs=mysqli_query($DB_LINK,"select * from discounts where dt='".$row1['admdate']."' and enrol='".$row1['enrol']."' ") ;
			...
			<td width="34%" align="right" >Total : </td>
			<td width="22%"  align="Right" ><?  echo $totfee=$feespaid; ?></td>
		  </tr> 
