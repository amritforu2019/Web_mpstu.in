...

{
	...
	if((!empty($_FILES["uploaded_file_small"])) && ($_FILES['uploaded_file_small']['error'] == 0))

	 {
		  ...
		  if (($ext == "jpg"||$ext == "jpeg"||$ext == "bmp"||$ext == "gif" ||$ext == "png") &&($_FILES["uploaded_file_small"]["size"] < 5000000000))
...

{
	...
	if((!empty($_FILES["uploaded_file_gallery"])) && ($_FILES['uploaded_file_gallery']['error'] == 0))

	 {
		  ...
		  if (($ext == "jpg"||$ext == "jpeg"||$ext == "bmp"||$ext == "gif" ||$ext == "png" ) &&($_FILES["uploaded_file_gallery"]["size"] < 50000000000))
